// Unlisted operator route: global profile editor. Day-to-day editing lives
// per-group-chat in /chats/[id]; this page stays for operator deep-dives.
...
export default function Profiles() {
  ...
  return (
    <>
      ...
      {profiles.map((p) => (
        <form key={p.handle} action={saveProfile} className="card">
